      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="mb-4 mt-auto">
          <div className="flex items-center justify-between mb-1">
            <p className="text-2xl font-bold text-foreground">
              {course.promoPrice}
              <span className="text-base font-bold text-foreground">/Mês</span>
            </p>
        ...
        <div className="flex justify-between items-center">
          <a
            ...
            className="inline-flex items-center justify-center rounded-full border-2 border-primary text-primary font-bold text-sm py-2 px-6 flex-shrink-0 hover:bg-primary hover:text-primary-foreground transition-colors"
          >
            SAIBA MAIS
          </a>
          <Button
