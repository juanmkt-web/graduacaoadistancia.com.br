        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12 animate-fade-in">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-extrabold text-[#050d21] mb-4 leading-tight">
              PERGUNTAS <span className="text-cyan-light">FREQUENTES</span>
            </h2>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqItems.map((item, index) => (
              <AccordionItem 
                key={index} 
                value={`item-${index}`}
                className="border border-gray-200 rounded-xl px-6 shadow-sm hover:shadow-md transition-shadow duration-300 bg-white"
              >
